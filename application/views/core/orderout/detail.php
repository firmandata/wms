			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						...
						<td><?php echo (!empty($record->estimation_harvest_time) ? date($this->config->item('server_display_date_format'), strtotime($record->estimation_harvest_time)) : '');?></td>
					</tr>
				</tbody>
			</table>
		</td>
...
<table class="table-data ui-widget ui-widget-content ui-corner-all" width="100%" cellspacing="0" cellpadding="0">
	<thead>
		<tr>
			...
			<th class="ui-state-default" rowspan="2">Size</th>
			...
			<th class="ui-state-default" rowspan="2">Total Amount</th>
...
foreach ($c_orderoutdetails as $c_orderoutdetail_idx=>$c_orderoutdetail)
{
	...
	elseif ($c_orderoutdetail->status_inventory_picklist == 'INCOMPLETE')
		...
		<tr>
			...
			<td class="ui-widget-content" align="right"><?php echo number_format_clear($c_orderoutdetail->size, 4);?></td>
			<td class="ui-widget-content"><?php echo $c_orderoutdetail->m_product_uom;?></td>
			<td class="ui-widget-content" align="right"><?php echo number_format_clear($c_orderoutdetail->price, 4);?></td>
			...
			<td class="ui-widget-content" align="right"><?php echo number_format_clear($c_orderoutdetail->price * $c_orderoutdetail->quantity, 4);?></td>
