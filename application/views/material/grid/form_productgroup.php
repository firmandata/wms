<table id="material_grid_productgroup_list_table"></table>
<div id="material_grid_productgroup_list_table_nav"></div>

<script type="text/javascript">
jQuery(function(){
	material_grid_productgroup_list_load_table('material_grid_productgroup_list_table');
});

function material_grid_productgroup_list_load_table(table_id){
	jQuery('#' + table_id).jqGrid({
		...
		url: "<?php echo site_url('material/grid/get_list_productgroup_json');?>", 
...
function material_grid_productgroup_form_submit(on_success){
	var id = jQuery("#material_grid_productgroup_list_table").getGridParam("selrow");
	if (!id)
	{
	...
	jQuery.ajax({
		url: "<?php echo site_url('material/grid/set_productgroup_by_ids');?>",
		data : {
