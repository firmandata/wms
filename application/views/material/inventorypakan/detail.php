...
<?php 
echo form_open('material/inventorypakan/detail',
	array(
...
jQuery(document).ready(function(){
	...
	jQuery("#material_inventory_detail_excel_btn").click(function(e){
		...
		document.location.href = "<?php echo site_url('material/inventorypakan/get_detail_list_excel');?>?" + params;
	});
...
function material_inventory_detail_list_load_table(table_id){
	jQuery('#' + table_id).jqGrid({
		...
		url: "<?php echo site_url('material/inventorypakan/get_detail_list_json');?>", 
		postData : material_inventory_detail_list_get_param(),
		colNames: [
			'Product Id', 
			'Product Code', 
