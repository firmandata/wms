...
jQuery(document).ready(function(){
	...
	jQuery("#material_inventory_summary_excel_btn").click(function(e){
		...
		document.location.href = "<?php echo site_url('material/inventorypakan/get_summary_list_excel');?>?" + params;
	});
});
...
function material_inventory_summary_list_load_table(table_id){
	jQuery('#' + table_id).jqGrid({
		...
		url: "<?php echo site_url('material/inventorypakan/get_summary_list_json');?>", 
		colNames: [
			'Product Id', 
			'Product Code', 
			'Product Name',
