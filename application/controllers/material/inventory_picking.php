...
class Inventory_picking extends MY_Controller 
{
	...
	public function index()
	{
		...
		$content = array(
			'title'		=> "Picking",
			'content' 	=> $this->load->view('material/inventory_picking/index', $data, TRUE)
		);
	...
	public function form()
	{
		...
		if ($id !== NULL)
		{
			...
			if ($table->num_rows() > 0)
			{
				...
				if ($record->status_inventory_shipment == 'COMPLETE')
					show_error("Picking was complete", 400);
			}
			else
		...
		$this->load->view('material/inventory_picking/form', $data);
	}
	...
	public function form_detail()
	{
		...
		$this->load->view('material/inventory_picking/form_detail', $data);
	}
	...
	public function get_list_form_json()
	{
		...
		$this->db
			...
			->select("ipgd.m_inventory_picking_id, ipgd.packed_group")
			->select("ipld.m_inventory_picklist_id, ipl.code m_inventory_picklist_code, ipl.picklist_date")
			...
			->group_by(
				array(
					'ipgd.m_inventory_picking_id', 'ipgd.packed_group',
					'ipld.m_inventory_picklist_id', 'ipl.code', 'ipl.picklist_date',
	...
	public function detail()
	{
		...
		$this->load->view('material/inventory_picking/detail', $data);
	}
