...
class Inventorypakan extends MY_Controller 
{
	...
	public function index()
	{
		...
		$content = array(
			...
			'content' 	=> $this->load->view('material/inventorypakan/index', $data, TRUE)
		);
	...
	public function summary()
	{
		...
		$this->load->view('material/inventorypakan/summary', $data);
	}
	...
	protected function get_summary_list_query()
	{
		...
		$inventory_sql = 
			...
			."			, inv.pallet "
			."			, inv.received_date, inv.price_buy "
		...
		$this->db
			...
			->where_not_in('pro.type', array('BENUR/BIBIT', 'UDANG'));
	}
	...
	public function detail()
	{
		...
		$this->load->view('material/inventorypakan/detail', $data);
	}
	...
	public function get_product_summary_list()
	{
		...
		$this->load->view('material/inventorypakan/report_by_product', $data);
	}
}